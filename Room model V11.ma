...
//Name: Room model V11.ma
//Last modified: Wed, Jan 29, 2025 04:00:04 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "355B9E9C-4E89-1BA3-43A1-5FB33E54E40B";
...
createNode transform -n "persp1";
	...
	setAttr ".t" -type "double3" 5.7649673358110896 7.1383831744746242 9.9433713062861724 ;
	setAttr ".r" -type "double3" -24.938350983665778 -16516.599999997998 2.1887321486985112e-15 ;
	setAttr ".rpt" -type "double3" 3.2502973781517293e-16 -5.8377675499261842e-16 -5.3039582431220644e-16 ;
createNode camera -n "persp1Shape" -p "persp1";
	rename -uid "B70927C8-4D90-ECE9-F519-B09737D929DB";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.902101921450559;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 2.3019325058894751 0.89218926840916657 6.0738473103231225 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "53E39BD1-4E78-AC7E-9112-9A922D6CDBFF";
	setAttr -s 71 ".lnk";
	setAttr -s 71 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9354E33E-49DA-0CD4-6DFB-B9A62F81CA0A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0B55AFBB-44BF-3744-15F2-B0A1F677AA35";
createNode displayLayerManager -n "layerManager";
	rename -uid "42B56685-4620-BDEF-B464-27B2ED953C55";
createNode displayLayer -n "defaultLayer";
	rename -uid "FA53C235-4301-C389-BC6A-F496A6301CF0";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "EB6DD675-4FE0-DBB4-D8D9-4BB17F59B125";
...
createNode polyTweak -n "polyTweak8";
	...
	setAttr ".uopa" yes;
	setAttr -s 10 ".tk";
	setAttr ".tk[16]" -type "float3" 0.0039966209 0 -4.4408921e-15 ;
	setAttr ".tk[17]" -type "float3" 0.0066782436 0 -4.4408921e-15 ;
	setAttr ".tk[18]" -type "float3" -0.068066813 0 -4.4408921e-15 ;
	setAttr ".tk[19]" -type "float3" -0.068066813 0 -4.4408921e-15 ;
	setAttr ".tk[20]" -type "float3" 0.0039966209 0 -4.4408921e-15 ;
	setAttr ".tk[21]" -type "float3" 0.0066782436 0 -4.4408921e-15 ;
	setAttr ".tk[22]" -type "float3" 0.0077890204 0 -4.4408921e-15 ;
	setAttr ".tk[23]" -type "float3" 0.0077890204 0 -4.4408921e-15 ;
...
createNode polyTweak -n "polyTweak9";
	...
	setAttr ".tk[44]" -type "float3" 0.15770029 5.9604645e-08 -0.14613879 ;
	setAttr ".tk[45]" -type "float3" -0.03825615 5.9604645e-08 -0.14613879 ;
	setAttr ".tk[46]" -type "float3" 0.15770029 5.9604645e-08 -0.088619992 ;
	setAttr ".tk[47]" -type "float3" -0.03825615 5.9604645e-08 -0.088619992 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
