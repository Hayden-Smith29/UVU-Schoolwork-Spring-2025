...
//Name: Room model V5.ma
//Last modified: Sun, Jan 26, 2025 06:19:11 PM
//Codeset: 1252
...
fileInfo "UUID" "F40874A8-4C29-B37C-FB5B-E2BE3D58E68A";
createNode transform -s -n "persp";
	rename -uid "88296380-4E0D-F954-CBDE-B3A5CD18C097";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.5526477140220578 3.7328625849913992 5.9609042928164531 ;
	setAttr ".r" -type "double3" -17.13835332103092 -14661.400000023606 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.0185435960392448;
...
createNode mesh -n "pasted__Cabinet_Shape1" -p "pasted__Cabinet_1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "35482557-445F-C00C-95A1-489C3F99D216";
	setAttr -s 69 ".lnk";
	setAttr -s 69 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9E3DF68F-434B-F2D1-5955-E79A930ECBD2";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8605E847-45C4-A736-1965-678B1698A6AD";
createNode displayLayerManager -n "layerManager";
	rename -uid "5141F1DD-4D1A-62F1-1277-0FBF1D1A168B";
createNode displayLayer -n "defaultLayer";
	rename -uid "FA53C235-4301-C389-BC6A-F496A6301CF0";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0A848C4E-4FDF-7E08-0F98-B3BE86FB0C8D";
...
connectAttr "pasted__polyCube8.out" "pasted__Cabinet_Shape1.i";
...
connectAttr "pasted__Cabinet_Shape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "groupId1.msg" ":initialShadingGroup.gn" -na;
connectAttr "groupId2.msg" ":initialShadingGroup.gn" -na;
// End of Room model V5.ma
