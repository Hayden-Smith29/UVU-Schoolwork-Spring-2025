...
//Name: Room model V7.ma
//Last modified: Sun, Jan 26, 2025 07:01:29 PM
//Codeset: 1252
...
fileInfo "UUID" "DEF3C968-4F6E-4983-BD87-C281DE84FC8E";
createNode transform -s -n "persp";
	rename -uid "88296380-4E0D-F954-CBDE-B3A5CD18C097";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.782995516995237 6.0117018230109807 13.422815438331472 ;
	setAttr ".r" -type "double3" -20.738350490291975 -15782.200000014684 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 14.556960112797391;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1000.1974993700237 1.2248361961478729 3.2650085354222536 ;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.7504364714482863 0.64336767934483541 1000.0024999141696 ;
...
createNode transform -n "Door_1" -p "Official_Cabinet";
	...
	setAttr ".rp" -type "double3" -0.058011925853393001 0.59854888211055235 -0.6822597516007276 ;
	setAttr ".sp" -type "double3" -0.49999999999999822 0.5 -0.5 ;
	setAttr ".spt" -type "double3" 0.44198807414660524 0.098548882110552308 -0.1822597516007276 ;
createNode mesh -n "Door_Shape1" -p "Door_1";
...
createNode transform -n "Door_2" -p "Official_Cabinet";
	...
	setAttr ".s" -type "double3" 0.11124025008833872 1.1477420609055493 1.6104708637638927 ;
	setAttr ".rp" -type "double3" -0.069380818211920561 0.59854888211055202 0.61488973392549173 ;
	setAttr ".sp" -type "double3" -0.49999999999999822 0.49999999999999956 0.5 ;
	setAttr ".spt" -type "double3" 0.43061918178807768 0.098548882110552433 0.11488973392549173 ;
createNode mesh -n "Door_Shape2" -p "Door_2";
...
createNode transform -n "Cabinet_1" -p "Official_Cabinet";
	...
	setAttr ".rp" -type "double3" -0.72902766191392032 0.82400897821540964 -0.37516082430331643 ;
	setAttr ".sp" -type "double3" -0.5 0.5 -2.2204460492503131e-16 ;
	setAttr ".spt" -type "double3" -0.22902766191392032 0.32400897821540964 -0.37516082430331621 ;
createNode mesh -n "Cabinet_Shape1" -p "Cabinet_1";
...
createNode transform -n "pasted__Cabinet_1" -p "Official_Cabinet";
	...
	setAttr ".rp" -type "double3" -0.90312150154119619 0.092758547645622746 -8.361412115516042e-17 ;
	setAttr ".sp" -type "double3" -0.50000000000000011 0.49999999999999645 -2.2204460492503131e-16 ;
	setAttr ".spt" -type "double3" -0.40312150154119608 -0.4072414523543737 1.3843048376987089e-16 ;
createNode mesh -n "pasted__Cabinet_Shape1" -p "|Official_Cabinet|pasted__Cabinet_1";
...
createNode transform -n "pSphere1";
	...
	setAttr ".rp" -type "double3" -0.10211536280551514 0.93278194632621081 -0.98561312449288607 ;
	setAttr ".rpt" -type "double3" -0.830666583520695 -1.0348973091317257 0 ;
	setAttr ".sp" -type "double3" -0.416778564453129 7.0023278950216614 -4.0227289199829066 ;
	setAttr ".spt" -type "double3" 0.31466320164761885 -6.0695459486954144 3.0371157954898371 ;
...
createNode transform -n "group2";
	rename -uid "AF07E1F5-4573-D72C-B9A5-65B8B2A3F826";
	setAttr ".t" -type "double3" 0 0 -0.98290119688554878 ;
	setAttr ".rp" -type "double3" 1.3539655088704192 0.82789341790128523 6.2004700061161531 ;
	setAttr ".sp" -type "double3" 1.3539655088704192 0.82789341790128523 6.2004700061161531 ;
createNode transform -n "group3";
	rename -uid "F7BE08ED-4680-570D-FB2C-14A2C9D1A923";
	setAttr ".t" -type "double3" 0 0 -0.61210515338517268 ;
	setAttr ".rp" -type "double3" 1.2182660180851435 0.99760796284035147 6.0821584463824578 ;
	setAttr ".sp" -type "double3" 1.2182660180851435 0.99760796284035147 6.0821584463824578 ;
createNode transform -n "pasted__pSphere1" -p "group3";
	rename -uid "9A030A6A-4CBD-2F7A-523E-EAAA0B329C90";
	setAttr ".t" -type "double3" 1.9806153890141984 1.0989565740588814 7.1030579003756174 ;
	setAttr ".r" -type "double3" 0 0 90 ;
	setAttr ".s" -type "double3" 0.020946566850621021 0.013916708165713994 0.020946566850621021 ;
	setAttr ".rp" -type "double3" -0.10211536280551514 0.93278194632621081 -0.98561312449288607 ;
	setAttr ".rpt" -type "double3" -0.830666583520695 -1.0348973091317257 0 ;
...
createNode transform -n "group4";
	rename -uid "AA5E31EA-4B44-BD56-0459-49AACECC3C5D";
	setAttr ".t" -type "double3" 0.96346978504840974 -0.59470505947602414 0 ;
	setAttr ".s" -type "double3" 0.075494649228039043 1 0.2146029276435337 ;
	setAttr ".rp" -type "double3" 0.23399587313945636 1.8210018986282885 5.7716541582371104 ;
	setAttr ".sp" -type "double3" 0.23399587313945636 1.8210018986282885 5.7716541582371104 ;
createNode transform -n "pasted__Official_Cabinet" -p "group4";
	rename -uid "E8ABFB5B-444D-2605-86BC-40A939050AE4";
	setAttr ".rp" -type "double3" 0.18005913954735098 0.88912169533639862 5.7716541582371104 ;
	setAttr ".sp" -type "double3" 0.18005913954735098 0.88912169533639862 5.7716541582371104 ;
...
createNode transform -n "pasted__Official_Cabinet" -p "group5";
	rename -uid "0CAF2EB8-4CD4-679E-CAF1-C6B5656F98A3";
	setAttr ".rp" -type "double3" 0.18005913954735098 0.88912169533639862 5.7716541582371104 ;
	setAttr ".sp" -type "double3" 0.18005913954735098 0.88912169533639862 5.7716541582371104 ;
createNode transform -n "pasted__Door_1" -p "|group5|pasted__Official_Cabinet";
	...
	setAttr ".sp" -type "double3" -0.49999999999999822 0.5 -0.5 ;
	setAttr ".spt" -type "double3" 0.44198807414660524 0.098548882110552308 -0.1822597516007276 ;
createNode mesh -n "pasted__Door_Shape1" -p "pasted__Door_1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pasted__Door_2" -p "|group5|pasted__Official_Cabinet";
	...
	setAttr ".sp" -type "double3" -0.49999999999999822 0.49999999999999956 0.5 ;
	setAttr ".spt" -type "double3" 0.43061918178807768 0.098548882110552433 0.11488973392549173 ;
createNode mesh -n "pasted__Door_Shape2" -p "pasted__Door_2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pasted__Cabinet_1" -p "|group5|pasted__Official_Cabinet";
	...
	setAttr ".sp" -type "double3" -0.5 0.5 -2.2204460492503131e-16 ;
	setAttr ".spt" -type "double3" -0.22902766191392032 0.32400897821540964 -0.37516082430331621 ;
createNode mesh -n "pasted__Cabinet_Shape1" -p "|group5|pasted__Official_Cabinet|pasted__Cabinet_1";
...
createNode transform -n "pasted__group3" -p "group5";
	rename -uid "FD9C010B-4E3F-07EB-5BBF-73AFD0CB5CBC";
	setAttr ".t" -type "double3" 0 0 -0.61210515338517268 ;
	setAttr ".rp" -type "double3" 1.2182660180851435 0.99760796284035147 6.0821584463824578 ;
	setAttr ".sp" -type "double3" 1.2182660180851435 0.99760796284035147 6.0821584463824578 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "821346FA-4FD7-19BE-9450-0B902CB595CD";
	setAttr -s 69 ".lnk";
	setAttr -s 69 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "659DDF3F-4B7C-8921-C2F3-BCB2C15CEF1E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "AD332A40-4A6F-1637-75F2-F58CEDF0789F";
createNode displayLayerManager -n "layerManager";
	rename -uid "1FC3C587-4E7F-52B7-1C33-8EAA046B7548";
createNode displayLayer -n "defaultLayer";
	rename -uid "FA53C235-4301-C389-BC6A-F496A6301CF0";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "090BCFED-477B-0509-6A78-4A99559B9162";
...
connectAttr "pasted__pasted__polyCube9.out" "Door_Shape1.i";
connectAttr "pasted__pasted__pasted__polyCube10.out" "Door_Shape2.i";
connectAttr "polyCube7.out" "Cabinet_Shape1.i";
connectAttr "pasted__polyCube8.out" "|Official_Cabinet|pasted__Cabinet_1|pasted__Cabinet_Shape1.i"
		;
connectAttr "polyExtrudeEdge3.out" "pSphereShape1.i";
connectAttr "pasted__polyExtrudeEdge3.out" "|group3|pasted__pSphere1|pasted__pSphereShape1.i"
		;
connectAttr "pasted__pasted__pasted__polyCube9.out" "pasted__Door_Shape1.i";
connectAttr "pasted__pasted__pasted__pasted__polyCube13.out" "pasted__Door_Shape2.i"
		;
connectAttr "pasted__polyCube9.out" "|group5|pasted__Official_Cabinet|pasted__Cabinet_1|pasted__Cabinet_Shape1.i"
		;
connectAttr "pasted__polyExtrudeEdge5.out" "|group5|pasted__pSphere1|pasted__pSphereShape1.i"
		;
connectAttr "pasted__pasted__polyExtrudeEdge3.out" "pasted__pasted__pSphereShape1.i"
		;
...
connectAttr "|group3|pasted__pSphere1|pasted__pSphereShape1.wm" "pasted__polyExtrudeEdge3.mp"
		;
...
connectAttr "|group3|pasted__pSphere1|pasted__pSphereShape1.wm" "pasted__polyExtrudeEdge2.mp"
		;
...
connectAttr "|group5|pasted__pSphere1|pasted__pSphereShape1.wm" "pasted__polyExtrudeEdge5.mp"
		;
...
connectAttr "|group5|pasted__pSphere1|pasted__pSphereShape1.wm" "pasted__polyExtrudeEdge4.mp"
		;
...
connectAttr "Cabinet_Shape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "Cabinet_Shape2.iog" ":initialShadingGroup.dsm" -na;
connectAttr "Door_Shape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "Door_Shape2.iog" ":initialShadingGroup.dsm" -na;
connectAttr "|Official_Cabinet|pasted__Cabinet_1|pasted__Cabinet_Shape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "pSphereShape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "|group3|pasted__pSphere1|pasted__pSphereShape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|group5|pasted__Official_Cabinet|pasted__Cabinet_1|pasted__Cabinet_Shape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "pasted__Door_Shape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "pasted__Door_Shape2.iog" ":initialShadingGroup.dsm" -na;
