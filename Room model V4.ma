...
//Name: Room model V4.ma
//Last modified: Fri, Jan 24, 2025 11:33:19 PM
//Codeset: 1252
...
fileInfo "UUID" "8D2769CB-468B-D2E0-D9A3-C984D4FF72A1";
createNode transform -s -n "persp";
	rename -uid "88296380-4E0D-F954-CBDE-B3A5CD18C097";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.469047005502189 6.7433502336596103 11.489696011422414 ;
	setAttr ".r" -type "double3" -13.538353628677623 -13997.399999998819 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 16.865390606383102;
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr -s 80 ".pt[0:79]" -type "float3"  0.40931138 0 -0.27123353 
		...
		0.40931091 -0.010923229 -0.27123353 -0.81898022 -0.011432931 -2.9802322e-08 -0.94667435 
		2.2351742e-08 -3.1930593e-08 0.40931138 0 -0.27123353 0.40931138 0 -0.27123353 0.40931138 
