...
//Name: Room model V8.ma
//Last modified: Sun, Jan 26, 2025 07:18:10 PM
//Codeset: 1252
...
fileInfo "UUID" "BA121A65-4C7D-C617-29D2-B282235AF489";
createNode transform -s -n "persp";
	rename -uid "88296380-4E0D-F954-CBDE-B3A5CD18C097";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.6877119080644878 8.209872446147763 10.999869388944436 ;
	setAttr ".r" -type "double3" -27.938350747497921 -15782.600000018685 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 16.310071624058843;
...
createNode mesh -n "Upper_Cabinet1Shape" -p "Upper_Cabinet1";
...
createNode mesh -n "Sink_Cabinet1Shape" -p "Sink_Cabinet1";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "2EA5BDD3-4537-7471-65C2-7892BA3D7D1D";
...
connectAttr "Wood_color.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
