...
//Name: Room model V6.ma
//Last modified: Sun, Jan 26, 2025 06:39:23 PM
//Codeset: 1252
...
fileInfo "UUID" "CE3F5BB8-4CEC-78EE-FB53-849C7896C4C2";
createNode transform -s -n "persp";
	rename -uid "88296380-4E0D-F954-CBDE-B3A5CD18C097";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 16.199933084595639 2.2222223598276476 5.3481007690296396 ;
	setAttr ".r" -type "double3" -9.9383533224491494 -15047.400000003316 -2.6589638965981437e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.285950062551667;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1000.1974993700237 2.9024999141693009 2.0417120743649608 ;
	setAttr ".r" -type "double3" 0 -90 0 ;
	setAttr ".rpt" -type "double3" -2.1795142948532344e-14 1.0533081523384413e-14 -3.5948154686703221e-14 ;
createNode camera -s -n "frontShape" -p "front";
	...
	setAttr ".tp" -type "double3" -0.097499370023228948 2.9024999141693115 2.0417120743649249 ;
...
createNode transform -n "Cabinet_2" -p "group";
	rename -uid "313C4E2A-4E3E-982A-3C03-AA8F2023B84E";
	setAttr ".t" -type "double3" -2.2709723380860796 0.90423441171232954 1.3458627629627511 ;
	setAttr ".s" -type "double3" 1.4322600897720337 1.6782433891826811 3.12458043358036 ;
	setAttr ".rp" -type "double3" -0.72902766191392065 -0.85423441096727148 1.2596955459138797 ;
	setAttr ".sp" -type "double3" -0.5 -0.5 0.5 ;
	setAttr ".spt" -type "double3" -0.22902766191392068 -0.35423441096727148 0.75969554591387978 ;
createNode mesh -n "Cabinet_Shape2" -p "Cabinet_2";
	rename -uid "58ECD1AA-4382-AE2E-5863-578E4C08449B";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "Official_Cabinet";
...
createNode transform -n "Door_1" -p "Official_Cabinet";
	rename -uid "FBDF9469-465C-6843-3050-FE8E005482CC";
	setAttr ".t" -type "double3" 1.0625945693623002 0.88912169533639851 6.5644063793695704 ;
	setAttr ".s" -type "double3" 0.11602385170678642 1.1970977642211049 1.3645195032014523 ;
	setAttr ".rp" -type "double3" -0.058011925853391051 0 0.68225975160072627 ;
	setAttr ".sp" -type "double3" -0.49999999999998046 0 0.5 ;
	setAttr ".spt" -type "double3" 0.44198807414658942 0 0.18225975160072622 ;
createNode transform -n "transform4" -p "Door_1";
	rename -uid "218E5BAA-45DC-CC8F-198A-9280E3FB92B9";
	setAttr ".v" no;
createNode mesh -n "Door_Shape1" -p "transform4";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "Door_2" -p "Official_Cabinet";
	rename -uid "E017EE86-450D-63D1-6E87-2985C8E510A9";
	setAttr ".t" -type "double3" 1.0739634617208296 0.88912169533639807 5.0462717602654417 ;
	setAttr ".s" -type "double3" 0.11602385170678642 1.1970977642211049 1.3645195032014523 ;
	setAttr ".rp" -type "double3" -0.069380818211920561 -8.3266726846886741e-17 -0.74962976927596081 ;
	setAttr ".sp" -type "double3" -0.49999999999999822 0 -0.50000000000000044 ;
	setAttr ".spt" -type "double3" 0.43061918178807768 -8.3266726846886741e-17 -0.24962976927596039 ;
createNode transform -n "transform1" -p "Door_2";
	rename -uid "015DBFB8-472B-8CC2-C41D-11B73E97D8B9";
	setAttr ".v" no;
createNode mesh -n "Door_Shape2" -p "transform1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "Cabinet_1" -p "Official_Cabinet";
	...
	setAttr ".s" -type "double3" 1.6490468916651468 1.6782433891826811 3.2697127404343922 ;
	setAttr ".rp" -type "double3" -0.72902766191392065 -0.85423441096727148 1.2596955459138797 ;
	setAttr ".sp" -type "double3" -0.5 -0.5 0.5 ;
	setAttr ".spt" -type "double3" -0.22902766191392068 -0.35423441096727148 0.75969554591387978 ;
createNode transform -n "transform2" -p "Cabinet_1";
	rename -uid "30F5460A-4878-B619-DC1B-8DA7FC8558B1";
	setAttr ".v" no;
createNode mesh -n "Cabinet_Shape1" -p "transform2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pasted__Cabinet_1" -p "Official_Cabinet";
	rename -uid "CCCB8DA2-4945-4255-EE4D-8BAC0F4719DE";
	setAttr ".t" -type "double3" 0.25865719525597386 1.8210018986282885 5.7716541582371104 ;
	setAttr ".s" -type "double3" 1.7569203588493572 0.18551709529124513 3.5552888337620905 ;
	setAttr ".rp" -type "double3" -0.9031215015411963 -0.092758508700548456 0 ;
	setAttr ".sp" -type "double3" -0.50000000000000011 -0.49999979007285589 0 ;
	setAttr ".spt" -type "double3" -0.40312150154119619 0.40724128137230742 0 ;
createNode transform -n "transform3" -p "pasted__Cabinet_1";
	rename -uid "596A933C-48A9-70D3-B83F-55BB7DA524C9";
	setAttr ".v" no;
createNode mesh -n "pasted__Cabinet_Shape1" -p "transform3";
...
createNode transform -n "Cabinet";
	rename -uid "DE1FDB9C-4826-2E50-9EEC-DE8547BB8DD6";
	setAttr ".t" -type "double3" -2.3555356860160828 0 -5.081515151593341 ;
	setAttr ".s" -type "double3" 1 1 1.0541101825007022 ;
	setAttr ".rp" -type "double3" -0.64446431398391724 0.050000011920928955 7.7858715529910576 ;
	setAttr ".sp" -type "double3" -0.64446431398391724 0.050000011920928955 7.4065103530883789 ;
	setAttr ".spt" -type "double3" 0 0 0.37936119990267836 ;
createNode mesh -n "CabinetShape" -p "Cabinet";
	rename -uid "B7A8B53C-40B2-7797-1BFF-85BA2AEAB659";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "620C6AC8-4996-EE2A-E97F-7EAF7E53B88E";
	setAttr -s 69 ".lnk";
	setAttr -s 69 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4C5BDC2A-4046-42D9-AEB7-17B5ABA904E9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EBC77021-42FC-DB2C-2DB5-B9AEE5109C8C";
createNode displayLayerManager -n "layerManager";
	rename -uid "03FB12E9-4AFB-08A6-C52D-9EB08E4FE2F4";
createNode displayLayer -n "defaultLayer";
	rename -uid "FA53C235-4301-C389-BC6A-F496A6301CF0";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8FA9DB1D-489D-1268-0AD9-D396C85D7D1F";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "9913CF7F-40D7-1CFF-5D3D-E3BDED344EB6";
...
createNode polyCube -n "pasted__polyCube7";
	rename -uid "EC785F91-4056-68C2-4750-EC93BECEC5FC";
	setAttr ".cuv" 4;
...
createNode polyUnite -n "polyUnite1";
	rename -uid "22051200-422A-94B6-F2E7-49B350C7FFBC";
	setAttr -s 4 ".ip";
	setAttr -s 4 ".im";
createNode groupId -n "groupId6";
	rename -uid "06F76F2E-427A-0003-D0E5-68AF06475F53";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts5";
	rename -uid "93BB1EA6-48DD-2DEE-2509-9C9A23171EC8";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:5]";
createNode groupId -n "groupId7";
	rename -uid "36F0FE01-471D-D78F-2282-79A5ADF8F5DF";
	setAttr ".ihi" 0;
createNode groupId -n "groupId8";
	rename -uid "3D95AB56-4AC6-771C-E067-898C68B98EF1";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts6";
	rename -uid "BE149CF4-4C1D-4EA9-34DB-F6BF04C52EC4";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:5]";
createNode groupId -n "groupId9";
	rename -uid "2AEC30CB-43DE-17AB-CAA4-389A7771110A";
	setAttr ".ihi" 0;
createNode groupId -n "groupId10";
	rename -uid "64831C21-40E8-9594-5483-2283AAA8ED84";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts7";
	rename -uid "12D47A0F-41A9-00F3-F836-998A0095C4B2";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:5]";
createNode groupId -n "groupId11";
	rename -uid "120CAF97-4DC9-1637-FC67-E4B202E93CA5";
	setAttr ".ihi" 0;
createNode groupId -n "groupId12";
	rename -uid "6311152E-48D0-ECAE-2701-388D6AB2FFCF";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts8";
	rename -uid "96537DF0-44DB-8C27-040D-68875E982DE7";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:5]";
createNode groupId -n "groupId13";
	rename -uid "10F6FD3A-478B-207E-11FB-A497869C2F54";
	setAttr ".ihi" 0;
createNode groupId -n "groupId14";
	rename -uid "26F90428-48E9-936D-A0CC-7BB74B15B4BC";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts9";
	rename -uid "66577C39-4F3C-77E8-7DC5-21909F2EEAC3";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:23]";
createNode groupId -n "groupId15";
	rename -uid "F0F5D455-408F-CFC1-2598-57B5130D21FA";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "pasted__polyCube7.out" "Cabinet_Shape2.i";
connectAttr "groupParts5.og" "Door_Shape1.i";
connectAttr "groupId6.id" "Door_Shape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Door_Shape1.iog.og[0].gco";
connectAttr "groupId7.id" "Door_Shape1.ciog.cog[0].cgid";
connectAttr "groupParts8.og" "Door_Shape2.i";
connectAttr "groupId12.id" "Door_Shape2.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Door_Shape2.iog.og[0].gco";
connectAttr "groupId13.id" "Door_Shape2.ciog.cog[0].cgid";
connectAttr "groupId10.id" "Cabinet_Shape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Cabinet_Shape1.iog.og[0].gco";
connectAttr "groupParts7.og" "Cabinet_Shape1.i";
connectAttr "groupId11.id" "Cabinet_Shape1.ciog.cog[0].cgid";
connectAttr "groupParts6.og" "pasted__Cabinet_Shape1.i";
connectAttr "groupId8.id" "pasted__Cabinet_Shape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "pasted__Cabinet_Shape1.iog.og[0].gco";
connectAttr "groupId9.id" "pasted__Cabinet_Shape1.ciog.cog[0].cgid";
connectAttr "groupParts9.og" "CabinetShape.i";
connectAttr "groupId14.id" "CabinetShape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "CabinetShape.iog.og[0].gco";
connectAttr "groupId15.id" "CabinetShape.ciog.cog[0].cgid";
...
connectAttr "Black_Tile.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "Door_Shape1.o" "polyUnite1.ip[0]";
connectAttr "pasted__Cabinet_Shape1.o" "polyUnite1.ip[1]";
connectAttr "Cabinet_Shape1.o" "polyUnite1.ip[2]";
connectAttr "Door_Shape2.o" "polyUnite1.ip[3]";
connectAttr "Door_Shape1.wm" "polyUnite1.im[0]";
connectAttr "pasted__Cabinet_Shape1.wm" "polyUnite1.im[1]";
connectAttr "Cabinet_Shape1.wm" "polyUnite1.im[2]";
connectAttr "Door_Shape2.wm" "polyUnite1.im[3]";
connectAttr "pasted__pasted__polyCube9.out" "groupParts5.ig";
connectAttr "groupId6.id" "groupParts5.gi";
connectAttr "pasted__polyCube8.out" "groupParts6.ig";
connectAttr "groupId8.id" "groupParts6.gi";
connectAttr "polyCube7.out" "groupParts7.ig";
connectAttr "groupId10.id" "groupParts7.gi";
connectAttr "pasted__pasted__pasted__polyCube10.out" "groupParts8.ig";
...
connectAttr "Cabinet_Shape2.iog" ":initialShadingGroup.dsm" -na;
connectAttr "Door_Shape1.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Door_Shape1.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "pasted__Cabinet_Shape1.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "pasted__Cabinet_Shape1.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Cabinet_Shape1.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Cabinet_Shape1.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Door_Shape2.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "Door_Shape2.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "CabinetShape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "CabinetShape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
